...
public class SProfilePacket extends Packet {
    ...
    public SProfilePacket(Action action, UserProfile profile) {
        this.action = action;
    ...
    public void write(ByteBuf byteBuf) {
        ...
        writeUserProfile(byteBuf, new UserProfile(profile.getUsername(), "CENSORED", profile.getMcUsername(), profile.getCurrentServer(), profile.getRank(), profile.getClient()));
    }
